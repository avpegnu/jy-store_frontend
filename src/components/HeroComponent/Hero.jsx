...
const Hero = () => {
  return (
    <div
      className="h-screen bg-gradient-to-b from-[#223179] to-[#7f8be722] flex"
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center gap-5 pl-44 leading-tight">
        ...
        <div className="flex justify-center items-center gap-4 w-[310px] h-[70px] rounded-full mt-8 bg-[#2b2264] text-white text-xl font-medium cursor-pointer hover:bg-[#211e33]">
